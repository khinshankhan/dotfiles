...
#+BEGIN_SRC emacs-lisp
  (use-package lsp-mode
    ...
    (add-to-list 'lsp-language-id-configuration '(caml-mode . "ocaml"))
    (add-to-list 'lsp-language-id-configuration '(tuareg-mode . "ocaml"))
    (add-to-list 'lsp-language-id-configuration '(reason-mode . "ocaml"))
    ...
    (lsp-register-client
     (make-lsp-client :new-connection (lsp-stdio-connection '("ocaml-language-server" "--stdio"))
                      :major-modes '(reason-mode tuareg-mode caml-mode)
