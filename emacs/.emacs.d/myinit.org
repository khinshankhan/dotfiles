...
=use-package= configuration. Helps clean up rest of the configuration and speeds up startup
by isolating packages. The =try= package lets you try packages before installing them.
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package dashboard
    ...
    (dashboard-startup-banner (concat user-emacs-directory "personal/marivector.png"))
