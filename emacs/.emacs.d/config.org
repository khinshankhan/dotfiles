...
** TODO Shell Paths
   ...
   This would be in the OS section, but it's needed for packages later on :sweat_smile:
...
** TODO Icons
   ...
   Currently dealing with a hack. Need to look into refining font spec when in daemon mode.
